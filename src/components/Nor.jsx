...
export default function Nor() {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold text-center mb-6">NOR Gate</h1>
      <div className="w-full max-w-6xl mx-auto p-6 space-y-6 min-h-screen">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full h-48 flex items-center justify-center border-2 border-dashed rounded-2xl">
            <span className="text-gray-500">NOR Gate Image Placeholder</span>
          </div>

          <div className="p-4 rounded-xl bg-gray-100 h-full flex flex-col justify-center">
            <h2 className="text-xl font-semibold mb-2">NOR Gate Description</h2>
            <p className="text-gray-700 text-sm">
              A NOR gate is a digital logic gate that outputs 0 only when both
